...
public class LogInPage extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                File filePathFile = new File("C:\\Student_Database");
                File listPathFile = new File("C:\\Student_Database\\Student_List.txt");
     ...
     */
    public LogInPage() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(LogInPage.class.getResource("Student-3-icon.png")));
        ...
        btnLogIn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                File file = new File("C:\\Student_Database\\password.txt");
                if (file.exists()) {

                    try {
                        FileReader fileReader = new FileReader("C:\\Student_Database\\password.txt");
        ...
        label.setIcon(new ImageIcon(LogInPage.class.getResource("samiul.jpg")));
        label.setBounds(0, 0, 258, 403);
        panel.add(label);

        JLabel label_1 = new JLabel("");
        label_1.setHorizontalAlignment(SwingConstants.CENTER);
        label_1.setIcon(new ImageIcon(LogInPage.class.getResource("cmss.png")));
        label_1.setBounds(281, 11, 292, 150);
