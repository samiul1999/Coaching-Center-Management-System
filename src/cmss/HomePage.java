...
public class HomePage extends JFrame {
    ...
    String[] cols = {"Student ID", "Student Name"};
    String[][] rows = new String[30][2];

   
    public HomePage() {
        setTitle("Coaching Center Management - \"Home\"");
        setIconImage(Toolkit.getDefaultToolkit().getImage(HomePage.class.getResource("Student-3-icon.png")));
        //setUndecorated(true);
        setResizable(false);
       ...
       // label.setIcon(new ImageIcon(HomePage.class.getResource("cmss_icon.png")));
    ...
    void addDataToTable() {
        File pathFile = new File("C:\\Student_Database\\Student_List.txt");
        int count = 0;
        try {
            int i = 0;
