...
public class DeleteStudentPage extends JFrame {
	...
	public DeleteStudentPage() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(DeleteStudentPage.class.getResource("Student-3-icon.png")));
		//setUndecorated(true);
		setResizable(false);
		...
		//label.setIcon(new ImageIcon(DeleteStudentPage.class.getResource("jetlab full extra small.png")));
	...
	void choiceList() {
		File inputFile = new File("C:\\Student_Database\\Student_List.txt");
        try {
	...
	void deleteStudentRecord(String studentID) {
		File pathFile = new File("C:\\Student_Database\\"+studentID);
		File infoFile = new File("C:\\Student_Database\\"+studentID+".txt");
		String pathString = "C:\\Student_Database\\Student_List.txt";
		...
		lblMassege.setText("All information of this Student has been deleted...");
	}
