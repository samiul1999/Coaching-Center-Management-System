...
public class StudentInformationPage extends JFrame {
    ...
    public StudentInformationPage() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(StudentInformationPage.class.getResource("Student-3-icon.png")));
        ...
        //label.setIcon(new ImageIcon(StudentInformationPage.class.getResource("")));
    ...
    void showDeta(String studentName) {
        String pathString = "C:\\Student_Database\\" + studentName + ".txt";
