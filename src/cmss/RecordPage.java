...
public class RecordPage extends JFrame {
	...
	public RecordPage() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(RecordPage.class.getResource("Student-3-icon.png")));
		...
		//label.setIcon(new ImageIcon(RecordPage.class.getResource("jetlab full extra small.png")));
	...
	void dataInsarted(String string) {
		String filePathString = "C:\\Student_Database\\"+string+"\\Class_Record.txt";
