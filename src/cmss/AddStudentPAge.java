...
public class AddStudentPAge extends JFrame {
    ...
    public AddStudentPAge() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(AddStudentPAge.class.getResource("Student-3-icon.png")));
        //setUndecorated(true);
        setResizable(false);
        ...
        //label.setIcon(new ImageIcon(AddStudentPAge.class.getResource("cmss_icon.png")));
        ...
        btnAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                File folder = new File("C:\\Student_Database\\" + studentIdString);
                folder.mkdir();
                File classRecordFile = new File("C:\\Student_Database\\" + studentIdString + "\\Class_Record.txt");
                File paymentFile = new File("C:\\Student_Database\\" + studentIdString + "\\Payment_Record.txt");
                File detailFile = new File("C:\\Student_Database\\" + studentIdString + ".txt");
                try {
                ...
                try {
                    FileWriter fileWriter = new FileWriter("C:\\Student_Database\\" + studentIdString + ".txt", true);
                    FileWriter nameUpWriter = new FileWriter("C:\\Student_Database\\Student_List.txt", true);
                    ...
                    nameUpWriter.write(studentNameString + "\n");
